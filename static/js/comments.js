  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/kcarta/kcarta.github.io/pulls">pending</a>. It will appear when I have approved it.');
